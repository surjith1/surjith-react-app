...
<p className='text-xs font-weight-bold text-primary text-uppercase mb-1'>EARNINGS (MONTHLY)</p>
<p className='h5 mb-0 font-weight-bold text-gray-800'>$40,000</p>
</div>
...
<div className="row card-body align-items-center">
<div className="col mr-2">
<p className='text-xs font-weight-bold text-success text-uppercase mb-1'>EARNINGS (MONTHLY)</p>
<p className='h5 mb-0 font-weight-bold text-gray-800'>$215,000</p>
</div>
<div className="col-auto">
...
<div className="row card-body align-items-center">
<div className="col mr-2">
<p className='text-xs font-weight-bold text-info text-uppercase mb-1'>Tasks</p>
<p className='h5 mb-0 font-weight-bold text-gray-800'>$40,000</p>
</div>
<div className="col-auto">
...
<div className="row card-body align-items-center">
<div className="col mr-2">
<p className="text-xs font-weight-bold text-warning text-uppercase mb-1">EARNINGS (MONTHLY)</p>
<p className='h5 mb-0 font-weight-bold text-gray-800'>$40,000</p>
</div>
<div className="col-auto">
  ...
  <div className="col-lg-6 mb-4">
    ...
    <div className="card shadow mb-4">
      ...
      <div className="card-body">
        ...
        <a target="_blank" href="https://undraw.co/">Browse Illustrations on
          unDraw →</a>
      </div>
    </div>
    {/* Approach */}
